export const recordGeneratedMethods = {
    normalizeGeneratedEntry(raw, defaults = {}) {
        const sourceDefault = typeof defaults?.source === 'string' && defaults.source.trim()
        ...
        const strategyRequest = entry.strategyRequest && typeof entry.strategyRequest === 'object'
