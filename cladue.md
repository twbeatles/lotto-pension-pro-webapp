...
Current doc/ignore audit baseline: 2026-06-10 maintained Markdown and `.gitignore` coverage were checked against the codebase, including `.codegraph/`; deleted dated review/audit docs are intentionally not restored unless requested.
